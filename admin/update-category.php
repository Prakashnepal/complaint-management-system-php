                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <form method="post" name="Category">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo  $row['categoryName']; ?>"  name="category" class="form-control" required="true">

                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Description</label>

                                                <textarea name="description"  class="form-control"><?php echo  $row['categoryDescription']; ?></textarea>
