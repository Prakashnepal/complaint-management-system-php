                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <table class="table table-hover datatable-1 table table-bordered table-striped	 display">
                            ...
                            <tbody>
                                <tr>
                                    <?php $query = mysqli_query($con, "SELECT * FROM tblcomplaints WHERE userId='" . $_SESSION['user_id'] . "'");
                                    ...
                                    ?>
                                        ...
                                        <td ><?php
                                            ...
                                            <?php } ?>
                                        <td> <a href="complaint-details.php?cid=<?php echo $row['complaintNumber']; ?>" class="btn btn-primary btn-sm"> View Details</a>
                                </tr>
                            <?php
                                    }
                            ?>
