...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "UPDATE users SET fullName='$fname',contactNo='$contactno',country='$country',State='$state',districtName='$district',municipalName='$municipal',wardNo='$wardno',address='$tole',userImage='$file_name',pincode='$pincode' where id = '$user_id'");
                                            ...
                                            ?>
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <label for="exampleInputEmail1">Photo </label>
                                                            ...
                                                            <input type="file" name="photo" value="<?php echo $get['userImage'] ?>" class=" form-control" required>
                                                        </div>
                                                        <div class="col-md-5">
