               ...
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="users/user-login.php">User Login</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="users/registration.php">User Regsitration</a>
                        </li>
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <h1 style="color: blue;" class="banner_taital">Lodge Your Complaint </h1>
